...
var (
	emptyChar = []uint8{0x00, 0x00, 0x00, 0x00, 0x00, 0x00}

	asciiTable = map[rune][]uint8{
		' ': emptyChar,
		...
		'b': {0x7F, 0x50, 0x48, 0x48, 0x30, 0x00},
		...
		'm': {0x78, 0x04, 0x78, 0x04, 0x78, 0x00},
...
func mapASCII(char rune) []uint8 {
	if data, ok := asciiTable[char]; ok {
		return data
	}
